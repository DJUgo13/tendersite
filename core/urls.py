...
urlpatterns = [
    ...
    path('tender/<int:tender_id>/agree/', views.agree_to_tender, name='agree_to_tender'),
    path('api/best-price/<int:direction_id>/', views.get_best_price, name='get_best_price'),
    path('api/my-history/<int:direction_id>/', views.get_my_bid_history, name='get_my_bid_history'),
    path('api/company-stats/', views.get_company_stats, name='get_company_stats'),
